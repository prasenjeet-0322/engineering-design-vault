...
This document contains the exact instruction prompt used by AI agents to process KPI learning interactions and convert them into structured documentation in this knowledge base.

> **Location in Central Prompt Vault:** [MASTER_PROMPT_1_DOCUMENTATION_GENERATOR.md](file:///d:/engineering/prompts/kpi-documentation/MASTER_PROMPT_1_DOCUMENTATION_GENERATOR.md)
