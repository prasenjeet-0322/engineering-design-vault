...
| [06. Refs & Mutable Instance Coordination in Hooks](./06-refs-and-mutable-instance-coordination.md) | ⏳ Pending | Latest value ref pattern, previous value tracking, hardware coordination. | 🧪 Lab 06 |
| [07. Context Gateways & Ambient Dependency Hooks](./07-context-gateways-and-ambient-dependency-hooks.md) | ⏳ Pending | Fail-fast invariant guards, private Context tokens, domain hook gateways. | 🧪 Lab 07 |
