...
| [useTransition, startTransition & Non-Blocking UI](./02-usetransition-and-non-blocking-rendering.md) | ⏳ Pending | Decoupling urgent input state from transition state, interruptibility, isPending feedback. |
| [useDeferredValue & Deferred Subtree Optimization](./03-usedeferredvalue-and-deferred-props.md) | ⏳ Pending | Deferring values vs debouncing, dual-pass rendering, pairing with React.memo for bailouts. |
