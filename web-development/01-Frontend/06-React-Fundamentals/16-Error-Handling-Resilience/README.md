...
| :--- | :---: | :--- | :---: |
| [React Error Boundaries & Component-Tree Failure Isolation](./01-error-boundaries-isolation.md) | ✅ Completed | componentDidCatch, getDerivedStateFromError, nearest boundary search, failure blast radius. | [🧪 Lab 01](./examples/01-error-boundaries-isolation.html) |
| [Render Errors vs Async Errors, Event Errors & Failure-Surface Classification](./02-render-errors-vs-async-errors.md) | ✅ Completed | What Error Boundaries catch (render, lifecycle) vs what they miss (async, events, SSR). | [🧪 Lab 02](./examples/02-render-errors-vs-async-errors.html) |
