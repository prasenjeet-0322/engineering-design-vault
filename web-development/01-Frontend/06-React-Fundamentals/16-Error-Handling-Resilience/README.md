...
| [Render Errors vs Async/Event Handler Errors](./02-render-errors-vs-async-errors.md) | ⏳ Pending | What Error Boundaries catch (render, lifecycle) vs what they miss (async, events, SSR). | ⏳ Pending |
