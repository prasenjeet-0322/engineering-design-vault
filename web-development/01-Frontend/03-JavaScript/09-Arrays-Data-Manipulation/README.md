...
| **Part 5** | `reduce()` — Accumulation, Grouping & Anti-Patterns | [05-reduce-accumulation-grouping-antipatterns.md](./05-reduce-accumulation-grouping-antipatterns.md) | GroupBy, indexing maps, $O(N^2)$ spread traps, and when NOT to use `reduce` | 🟡 In Progress |
