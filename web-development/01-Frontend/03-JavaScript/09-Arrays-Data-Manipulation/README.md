...
| **Part 6** | `sort()` — In-Place Mutation, Comparators & `toSorted()` | [06-sort-comparators-stable-ordering.md](./06-sort-comparators-stable-ordering.md) | ASCII string coercion trap, TimSort stability, ES2023 `toSorted()`, and multi-field sorting | 🟡 In Progress |
