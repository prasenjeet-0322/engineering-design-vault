...
| **Part 7** | `flat()` & `flatMap()` — Nested Structural Transformations | [07-flat-flatmap-nested-structures.md](./07-flat-flatmap-nested-structures.md) | Depth flattening, mapping with 0 or many results, and tag normalizations | 🟡 In Progress |
