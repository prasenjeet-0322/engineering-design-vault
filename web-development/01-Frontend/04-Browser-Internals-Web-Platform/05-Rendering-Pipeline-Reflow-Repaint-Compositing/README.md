# KPI 05 — Rendering Pipeline (Reflow, Paint, Compositing)
...
## 🎯 Purpose
Render tree, layout geometry, layout thrashing, paint & Skia rasterization, GPU compositing layers, will-change
